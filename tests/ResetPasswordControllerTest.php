...
class ResetPasswordControllerTest extends WebTestCase
{
    ...
    public function testResetPasswordController(): void
    {
        // Create a test user
        $user = (new User())
            ->setEmail('testerconf1@gmail.com')
        ...
        $this->client->submitForm('Send password reset email', [
            'reset_password_request_form[email]' => 'testerconf1@gmail.com',
        ]);
        ...
        self::assertEmailAddressContains($messages[0], 'from', 'ingenieurbanconle@gmail.com');
        self::assertEmailAddressContains($messages[0], 'to', 'testerconf1@gmail.com');
